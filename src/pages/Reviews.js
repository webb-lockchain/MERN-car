...
const data = [
  {
    ...
    desc: [
      <MotoringHubCard
        ...
        url={"/motoring-hub/review-detail"}
      />,
      <MotoringHubCard
...
const active=1
  ...
  return (
    <MainLayout>
              ...
              <div className="overflow-x-scroll md:overflow-x-hidden flex flex-row w-full md:w-1/3">
                {data.map(({ label, value }) => (
                  ...
                  >
                    <div
                      className={`${
                        activeTab !== value ? "text-black" : "bg-gray-900 text-white"
      ...
      <div className="max-w-[1240px] bg-gray-100 w-full mx-auto  px-8 py-[50px] mb-[50px] bg-neutral-100 rounded-3xl flex-col justify-start items-center gap-8 hidden md:flex">

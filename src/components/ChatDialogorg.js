...
const ChatDialog = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`z-[123] chat-dialog fixed bottom-4 right-4 bg-white border border-gray-300 shadow-md p-4 transition-all${isOpen
                ? "bottom-4"
                : "-bottom-[200px]"}`}>
            <div className="font-sans fixed flex rounded-3xl shadow-2xl items-end z-10 bottom-[35px] right-[35px] sm:bottom-[20px] sm:right-[20px] sm:top-auto sm:left-auto">
                <div className={`fixed sm:w-[370px] rounded-3xl shadow-lg flex flex-col  sm:right-[35px] sm:top-auto sm:left-auto sm:h-[650px] transition-all ${isOpen ? "inset-4 sm:bottom-11" : "block -bottom-[700px]"}`}>
                    <div className="h-32 rounded-3xl shadow-black w-full pt-4 px-8 pb-14 flex items-center justify-between rounded-t-4xl bg-[#ffffff] text-[#000000]">
                        <div className="ml-8 flex-grow">
                            <img src="https://visitorchat-client.s3.eu-west-2.amazonaws.com/app/chatbox/1631261759-Capture.PNG"
                        ...
                        <div className="text-sm">
                            ...
                            <div className="w-full flex gap-2 p-3">
                                <textarea
                                    ...
                                    className="w-full py-3 border rounded-sm test whitespace-pre-wrap break-words overflow-auto selection:border-blue-800 resize-y max-h-36 min-h-[48px] px-4 text-base target:border-none active:border-none border-blue-800 focus:border-blue-900 focus-within:border-blue-900 focus-visible:border-none"></textarea>

...
export default function MyPortal() {
  ...
  return (
      <div className="py-6 flex flex-col justify-center bg-white">
          <div className="  text-gray-900 font-barlow text-base font-normal leading-6 lowercase">{more ? description.join(' ') : description[0]}</div>   
          <div className="mt-4 hover:cursor-pointer hover:text-blue-800 text-blue-600 font-barlow text-base font-normal leading-6"  onClick={handleReadMore}  >Read {more?'less':'more'} </div><div className="text-sm mt-6 w-full md:w-1/2 bg-[#f6f6f6] rounded-2xl">

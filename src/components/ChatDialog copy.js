...
const ChatDialog = ({ isOpen, onClose }) => {
  return (
    <div
      className={`z-[123] fixed bottom-10 right-4 bg-white border border-gray-300 shadow-md  transition-all${isOpen ? "bottom-4" : "-bottom-[200px]"
        }`}
    >
      <div className="font-sans fixed flex rounded-3xl shadow-2xl items-end z-10 bottom-[35px] right-[35px] sm:bottom-[20px] sm:right-[20px] sm:top-auto sm:left-auto">
        <div className={`bg-white fixed sm:w-[370px] rounded-3xl shadow-lg flex flex-col  sm:right-[35px] sm:top-auto sm:left-auto sm:h-[650px] transition-all ${isOpen ? "inset-4 sm:bottom-11" : "block -bottom-[700px]"
          }`}
        >

...
export function VehicleCard1({ item, ele }) {
    const {
        name,
        price,
        desc,
    ...
    return (
        <div className='  md:max-w-[320px] w-full flex flex-col mt-8 min-w-fit md:min-w-[280px] rounded-lg overflow-hidden'>
            <div className="w-full rounded-lg">
                <img src={image} alt={name} className='h-[240px]' />
            </div>
            ...
            <div className="mt-2 line-clamp-1 text-neutral-700 text-base font-normal font-['Barlow'] leading-normal  ">
                {desc}
            </div>
            ...
            <div className=' my-4 flex flex-wrap gap-2'>
                <div className="mt-2 flex-row min-w-[50px] justify-between items-center bg-white rounded-full px-2 py-1">
                    <div className="flex flex-row justify-between items-center ">
                        ...
                        <div className="text-neutral-700 text-xs font-medium font-['Barlow'] leading-[17px]">{distance} &nbsp;miles</div></div>
                </div>
                <div className="mt-2 text-gray-700 font-barlow text-12 font-medium leading-17 bg-white rounded-full px-2 py-1">
                    <div className="flex flex-row justify-between items-center ">
                        ...
                        <div className="text-neutral-700 text-xs font-medium font-['Barlow'] leading-[17px]">{fuel}</div>
                    </div>
                </div>
                ...
                <div className="mt-2 text-gray-700 font-barlow text-12 font-medium leading-17 bg-white rounded-full px-2 py-1 ">
                    <div className="flex flex-row justify-between items-center ">
                        ...
                        <div className="text-neutral-700 text-xs font-medium font-['Barlow'] leading-[17px]">{method}</div></div>
                </div>
                <div className="mt-2 text-gray-700 font-barlow text-12 font-medium leading-17 bg-white rounded-full px-2 py-1 ">
                    <div className="flex flex-row justify-between items-center ">
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.7713 11.6046C11.2496 12.1263 10.252 13.1239 9.4139 13.962C8.63285 14.743 7.36735 14.7431 6.58631 13.962C5.76391 13.1396 4.78317 12.1589 4.22885 11.6046C2.14605 9.52177 2.14605 6.14489 4.22885 4.0621C6.31164 1.9793 9.68852 1.9793 11.7713 4.0621C13.8541 6.14489 13.8541 9.52177 11.7713 11.6046Z" stroke="#0449C8" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M10.0001 7.83333C10.0001 8.9379 9.10465 9.83333 8.00008 9.83333C6.89551 9.83333 6.00008 8.9379 6.00008 7.83333C6.00008 6.72876 6.89551 5.83333 8.00008 5.83333C9.10465 5.83333 10.0001 6.72876 10.0001 7.83333Z" stroke="#0449C8" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>

                        <div className="text-neutral-700 text-xs font-medium font-['Barlow'] leading-[17px]">TMC - Huddersfield</div></div>
                </div>
            </div>
            <div className=" pt-4 flex justify-between border-t-[1px] border-gray-500">
                ...
                <div className=" flex flex-col h-fit">
                    <div className=" flex flex-row justify-end">
                        ...
                        <div className="text-black text-sm font-semibold font-['Barlow Condensed'] leading-tight">{from}</div>
                    </div>
                    <Link to={urlFinance} className=" text-blue-700 text-[10px] font-bold font-['Barlow'] underline uppercase leading-tight tracking-tight">View finance options</Link>
                </div>
            </div>
        </div>
    );
